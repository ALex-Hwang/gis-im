...
const data = [
	{
		key: '1',
		medNameZh: 'John Brown',
		
		other: 'New York No. 1 Lake Park',
	},
	{
		key: '2',
		medNameZh: 'Jim Green',
				...
				<Content className='mycontent'>
					...
					<div className="post-back-ground">
						...
						<div style={{ marginLeft: '10%', marginRight: '10%'}}>
							...
							<div class="prescribbox">
								<div class="presentbox">
									...
									<div class="basicbox1">
										...
										<label class="underline1" >打开的时候从数据库获取</label>

										<div class="labeltext_5">
											性别：
						         </div>
										<label class="underline2" >打开的时候从数据库获取</label>

										<div class="labeltext_6">
											年龄：
						         </div>
										<label class="underline3" >打开的时候从数据库获取</label>
							...
							<br />
							{
								(this.state.islogin === true && this.state.isDoctor === true) ? (
